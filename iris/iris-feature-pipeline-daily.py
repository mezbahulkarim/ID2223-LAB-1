...
if LOCAL == False:
   ...
   @stub.function(image=image, schedule=modal.Period(days=1), secret=modal.Secret.from_name("HOPSWORKS_API_KEY"))    #api key name
   def f():
       g()
...
def get_random_iris_flower():
    ...
    # randomly pick one of these 3 and write it to the featurestore             CHANGE RANDOM FUNCTION 
